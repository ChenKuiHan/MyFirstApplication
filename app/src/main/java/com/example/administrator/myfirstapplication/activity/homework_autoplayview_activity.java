 ...
 */
public class homework_autoplayview_activity extends BaseActivity {
    ...
    protected void contectview(Bundle savedInstanceState) {
        setContentView(R.layout.homework_autoplayview);
        ...
        BaseAdapter b=new BaseAdapter() {
            ...
            public View getView(int position, View convertView, ViewGroup parent) {
                ImageView iv=new ImageView(homework_autoplayview_activity.this);
